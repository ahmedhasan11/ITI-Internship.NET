...
namespace MVC_D2_Employee_DeptSystsem
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddDbContext<SystemContext>(options => options.UseSqlServer(builder.Configuration.GetConnectionString("DefaultConnectionString")));
			builder.Services.AddDefaultIdentity<IdentityUser>(options =>
			options.SignIn.RequireConfirmedAccount = false)
				.AddRoles<IdentityRole>() // Optional: Add support for roles
                .AddEntityFrameworkStores<SystemContext>() // Specify your DbContext
                .AddDefaultUI();
